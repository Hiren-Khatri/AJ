        ...
        try {
            /* TODO output your page here. You may use following sample code. */
                ...
                String EmptyFieldErr = "Field can't be empty!";
                    getServletContext().setAttribute("passMatch_err", EmptyFieldErr);
                    response.sendRedirect("signup.jsp");
                }
                else{
                if(!pass.equals(request.getParameter("reptPassword"))){
                    String passMatchErr = "Password not match";
                    getServletContext().setAttribute("passMatch_err", passMatchErr);
                    response.sendRedirect("signup.jsp");
                }
                else{
               // Connection  myCon = (Connection)getServletContext().getAttribute("dBConnection");
                    ...
                    MyDbConnection con = new MyDbConnection(url,dbName,dbPass,uname,pass);
                    
                    try {
                        Connection myCon = con.makeConnection(url, dbName, dbPass);
